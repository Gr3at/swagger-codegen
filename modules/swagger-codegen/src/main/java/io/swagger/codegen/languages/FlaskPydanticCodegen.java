...
public class FlaskPydanticCodegen extends DefaultCodegen implements CodegenConfig {

    private static final Logger LOGGER = LoggerFactory.getLogger(FlaskPydanticCodegen.class);
    ...
    public FlaskPydanticCodegen() {
         ...
         */
        embeddedTemplateDir = templateDir = "flaskConnexionPydantic";
        ...
        supportingFiles.add(new SupportingFile("pyproject.toml.mustache", "", "pyproject.toml"));
